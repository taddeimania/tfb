...
from tecmo_player import models as tecmo_player_models
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for pro_team in orm.Pro_Team.objects.all():
            tecmo_player_models.Pro_Team.objects.create(
                short=pro_team.short,
                long=pro_team.long,
                bye=pro_team.bye,
                wins=pro_team.wins,
                loss=pro_team.loss,
...
#            tecmo_player_models.Player.objects.create(
#                pos=player.pos,
...
#            )
        #
        #        for schedule in orm.Schedule.objects.all():
        #            tecmo_player_models.Schedule.objects.create(
        #                away=schedule.away,
        ...
        #        for stat in orm.Stats.objects.all():
        #            tecmo_player_models.Stats.objects.create(
        #                player=stat.player,
        #                week=stat.week,
        #                pa=stat.pa,
        #                pc=stat.pc,
    ...
    def backwards(self, orm):
        ...
        #        for stat in tecmo_player_models.Stats.objects.all():
        #            orm.Stats.objects.create(
        #                player=stat.player,
        #                week=stat.week,
        #                pa=stat.pa,
        #                pc=stat.pc,
