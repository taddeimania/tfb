...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stats.condition'
        db.add_column('players_stats', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='Average', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stats.condition'
        db.delete_column('players_stats', 'condition')
